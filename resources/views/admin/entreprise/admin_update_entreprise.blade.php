          ...
          <div class="col-md-10 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="{{ route('admin.EntrepriseUpdate') }}" enctype="multipart/form-data">
                    @csrf
                      <input type="hidden" name="id_ent" value="{{ $data->id_ent }}">
                      <div class="mb-3">
                          <label for="exampleInputUsername1" class="form-label">Name</label>
                          <input type="text" class="form-control" name="name" id="name" value="{{$data->name}}" autocomplete="off">
                      </div>
                      <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Domaine Activity</label>
                        <input type="email" class="form-control" name="domaine" id="domaine" value="{{$data->domaine->domaine_activity}}" autocomplete="off" disabled>
                      </div>
                      <div class="mb-3">
