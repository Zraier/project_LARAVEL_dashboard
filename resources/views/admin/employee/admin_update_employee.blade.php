          ...
          <div class="col-md-10 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="{{ route('admin.EmployeeUpdate') }}" enctype="multipart/form-data">
                    @csrf
                      ...
                      <div class="mb-3">
                        ...
                        <input type="email" class="form-control" name="ent" id="ent" value="{{$data->entreprise->name}}" autocomplete="off" disabled>
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                          ...
                          <img id="imageShow" class="wd-80 rounded-circle" src="{{ !empty($data->photo) ? url('upload/employee_image/'.$data->photo) : url('upload/no_image.jpg')}}" alt="profile">
